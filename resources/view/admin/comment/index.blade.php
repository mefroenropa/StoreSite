    ...
    <div class="pd-ltr-20">
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                ...
                <div class="pull-left">
                    <a href="<?= route('admin.comment.unConfirm') ?>" class="btn btn-warning d-inline"> نظرات تایید نشده </a>
							...
							<td>
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
										...
										<a class="dropdown-item" href="<?= route('admin.comment.isConfirm', ['2', $comment->id]) ?>"><i class="dw dw-edit2"></i> تغیر وضعیت به رد شده</a>
									</div>
								</div>
							</td>
						</tr>
